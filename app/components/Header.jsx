      ...
      <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            <li>
              <Link href="/about" className="block py-2 pr-4 pl-3 text-black border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0" aria-current="page">About</Link>
            </li>
            <li>
              <Link href="/browse" className="block py-2 pr-4 pl-3 text-black border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Browse Courses</Link>
            </li>
            <li>
              <Link href="/course/upload" className="block py-2 pr-4 pl-3 text-black border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Create a Course</Link>
            </li>
            <li>
              <Link href="/course/enrol" className="block py-2 pr-4 pl-3 text-black border-b border-gray-100 lg:hover:bg-transparent lg:border-0 lg:hover:text-primary-700 lg:p-0">Enrol into Course</Link>
            </li>
          </ul>
        </div>
      </div>
