...
const BrowseCoursesPage = () => {
  ...
  const posts = [
    {
      title: "The Complete Web3 Development Bootcamp 2024",
      desc: "Become a Full-Stack Web3 Developer with just ONE course. HTML, CSS, Javascript, Node, React, PostgreSQL, Web3 and DApps",
  ...
  return (
    <>
    <section className="mt-8 mb-6 mx-auto px-4 max-w-screen-xl md:px-8">
